...
function displayEventDetails(event) {
    ...
    document.getElementById('event-introduction').textContent = event.description[0].introduction;
    ...
    document.getElementById('hightlight1').textContent = 'Event highlight: '+event.description[0].highlight1;
    document.getElementById('hightlight2').textContent = 'Event highlight: '+event.description[0].highlight2;
